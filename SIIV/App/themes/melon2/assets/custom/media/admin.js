$("#sidebar-content #nav li .current").removeClass("current");
	$("#sidebar-content #nav li a[href='<?php echo Yii::app()->baseUrl; ?>/media/admin']").parent().parent().parent().addClass("current");
	$("#sidebar-content #nav li .sub-menu .current").removeClass("current");
	$("#sidebar-content #nav li .sub-menu li a[href='<?php echo Yii::app()->baseUrl; ?>/media/admin']").parent().addClass("current");
