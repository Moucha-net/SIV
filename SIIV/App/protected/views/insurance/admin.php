...
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/custom/insurance/admin.js',CClientScript::POS_END); ?>
<?php Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl.'/assets/custom/insurance/admin.css',CClientScript::POS_END); ?>
...
<?php 
    $this->widget('ext.gridMelon.MelonGrid',array(
            'modelo'=>$insurance, 
            'columnas'=>['idInsurance','Names','Street','Phone','Contact Names','idInsurance'],
            'colContenido'=>['idInsurance','name','street','phone','contact','idInsurance'],
            'modulo'=>'insurance', 
            'idModeloP'=>'idInsurance',
    ));        
