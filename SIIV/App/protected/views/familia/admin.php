...
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/custom/familia/admin.js',CClientScript::POS_END); ?>
<?php Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl.'/assets/custom/familia/admin.css',CClientScript::POS_END); ?>
...
<div class="crumbs">
	<ul id="breadcrumbs" class="breadcrumb">
		<li>
			<i class="icon-home"></i>
			<a href="<?php echo Yii::app()->baseUrl; ?>/familia/admin">Familia</a>
		</li>
	</ul>
</div>
<!-- /Breadcrumbs line -->

<h1>Administración de Familia</h1>
...
<?php 
    $this->widget('ext.gridMelon.MelonGrid',array(
            'modelo'=>$familia, 
            'columnas'=>['idFamilia','Familia','idFamilia'],
            'colContenido'=>['idFamilia','nombre','idFamilia'],
            'modulo'=>'familia', 
            'idModeloP'=>'idFamilia',
    ));        
