...
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/custom/moneda/admin.js',CClientScript::POS_END); ?>
<?php Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl.'/assets/custom/moneda/admin.css',CClientScript::POS_END); ?>
...
<div class="crumbs">
	<ul id="breadcrumbs" class="breadcrumb">
		<li>
			<i class="icon-home"></i>
			<a href="<?php echo Yii::app()->baseUrl; ?>/moneda/admin">Tipo de Moneda</a>
		</li>
	</ul>
</div>
<!-- /Breadcrumbs line -->

<h1>Administración del Tipo de Moneda</h1>
...
<?php 
    $this->widget('ext.gridMelon.MelonGrid',array(
            'modelo'=>$moneda, 
            'columnas'=>['idMoneda','Tipo de Moneda','idMoneda'],
            'colContenido'=>['idMoneda','nombre','idMoneda'],
            'modulo'=>'moneda', 
            'idModeloP'=>'idMoneda',
    ));        
