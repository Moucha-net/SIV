...
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/custom/job/form.js',CClientScript::POS_END); ?>
	...
	<div class="form-group">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<?php echo $form->textArea($model,'description',array('size'=>250,'maxlength'=>250,'rows'=>3,'cols'=>10,'class'=>'form-control input-width-xxlarge','placeholder'=>'Description')); ?>
			</div>
		</div>
	</div>
	<div class="form-group">
