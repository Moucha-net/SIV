...
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/custom/specialty/admin.js',CClientScript::POS_END); ?>
<?php Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl.'/assets/custom/specialty/admin.css',CClientScript::POS_END); ?>
...
<?php 
	$this->widget('ext.gridMelon.MelonGrid',array(
		'modelo'=>$specialty, 
		'columnas'=>['idSpecialty','Especialidad','Descripción','idSpecialty'],
		'colContenido'=>['idSpecialty','nombreEspecialidad','descripcion','idSpecialty'],
		'modulo'=>'specialty',
		'idModeloP'=>'idSpecialty',
	)); 
?>
