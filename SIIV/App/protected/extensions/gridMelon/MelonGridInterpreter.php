...
class MelonGridInterpreter extends CWidget
{
						...
						<div class='widget box'>
							<div class='widget-header'>
								...
								<div class='toolbar no-padding'>
									<div class='btn-group'>
										<a href='".Yii::app()->baseUrl."/cruge/ui/intermanagementcreate'><span class='btn btn-xs'><i class='icon-plus' style='padding-top: 6px;'></i> </span></a>
									</div>
								</div>
							</div>
							<div class='widget-content no-padding'>
								<table class='table table-striped table-bordered table-hover table-checkable datatable'>
									...
									foreach(Yii::app()->user->um->listUsers() as $user)
									{
										...
										$interprete = Yii::app()->user->um->getFieldValue($instancia_CrugeStoredUser,'interprete');
										if($interprete == 1)
										{
											...
											$instancia_CrugeStoredUser = Yii::app()->user->um->loadUser($user->email,true);										
											//$username =  $instancia_CrugeStoredUser->username;
											$cuentaVSEE = Yii::app()->user->um->getFieldValue($instancia_CrugeStoredUser,'cuentaVsee');

											echo "<td><span class='label label-success'>".$cuentaVSEE."</span></td>";
											

											echo "<td width='20px'>
											<a href='".Yii::app()->baseUrl."/cruge/ui/intermanagementupdate/id/".$user->iduser."'>
