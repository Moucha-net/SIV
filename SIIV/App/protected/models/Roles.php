...
class Roles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('roleName, lastModifiedDate', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'grants' => array(self::MANY_MANY, 'Grants', 'roleGrants(roleName, grantName)'),
			'users' => array(self::HAS_MANY, 'Users', 'roleName'),
		);
	}
