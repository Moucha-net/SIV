...
class Users extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('name, last_name, middle_name, maiden_name, roleName', 'length', 'max'=>45),
            array('lastModifiedDate', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, password, email, name, last_name, middle_name, maiden_name, roleName, lastModifiedDate', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            'roleName0' => array(self::BELONGS_TO, 'Roles', 'roleName'),
        );
    }
